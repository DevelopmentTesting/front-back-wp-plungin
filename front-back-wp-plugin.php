...
* Description: shortcode: [shortcode-profile] and this required personal-profile plugin to let the fb login working.
* activate personal-profile and activate this plugin next.
* Version: 
* Author: Mik Neri
* Author URI: 
*/

add_shortcode('shortcode-profile', 'profile_plugin_func' );
